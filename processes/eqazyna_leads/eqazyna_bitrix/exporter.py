...
COLUMNS = [
    ...
    ("action_label", "Итог по заявке"),
    ("application_exists", "Заявка уже существует"),
    ("lead_decision", "Решение по лиду"),
    ("action", "Техническое действие"),
    ("lead_id", "Bitrix Lead ID / найденный дубль"),
    ("company_id", "Компания ID"),
    ("company_action_label", "Что будет с компанией"),
    ("contact_id", "Контакт руководителя ID"),
    ("contact_action_label", "Что будет с контактом"),
    ("requisite_id", "Реквизит ID"),
    ("requisite_action_label", "Что будет с реквизитом"),
